...
const InvoiceTotals: React.FC<InvoiceTotalsProps> = ({
  ...
  const renderRow = (label: string, value: number, bold = false) => (
    <div className={`flex items-center justify-between px-4 py-3 border-b last:border-b-0 ${bold ? "font-medium text-lg" : "text-sm text-gray-500"}`}>
  ...
  return (
    <div className="bg-white rounded-xl shadow border border-[#e6edf5] p-0 overflow-hidden w-full max-w-md min-w-[300px]">
