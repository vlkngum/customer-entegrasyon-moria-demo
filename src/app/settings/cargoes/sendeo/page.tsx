...
export default function SendeoSettings() {
    ...
    <div className="min-h-screen p-0">
      <div className="pl-8 bg-white shadow-sm">
        <div className="font-semibold text-2xl flex items-center gap-3 py-5">
          <Image src={'/sendeo.svg'} alt="Sendeo" width={0} height={0} className="bg-[#f3f8fe] rounded-full w-14 h-14 flex items-center justify-center text-lg font-bold "/>
          Sendeo Ayarları
        </div>
      ...
      <div className="mt-6 mx-6">
        <div className="flex flex-row gap-6 mt-6" style={{minWidth: 1200}}>
          ...
          <div className="panel w-1/2 relative">
            ...
            <div className="pt-4">
              <div className="font-semibold text-base mb-2">1- API Bilgilerinizi Tanımlayın</div>
              <div className="text-gray-700 text-xs mb-4">
                Sendeo tarafından api bilgilerinizi istememiz gerekmektedir. Sizlere verilen bilgiler arasındaki parola ve şifrenizi lütfen yazınız.<br/><br/>
                Gönderim yapacağınız bilgilerin girilmesi ve doğruluğu çok önemli. Aksi taktirde siparişleriniz Sendeo tarafına iletilemeyecektir.
              </div>
            </div>
