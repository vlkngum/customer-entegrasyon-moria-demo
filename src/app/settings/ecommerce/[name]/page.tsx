...
export default function EcommerceDetailPage() {
  ...
  const ecommerceName = params?.name || '';
    ...
    <div className="min-h-screen bg-[#F5F7FA] flex flex-col items-center py-0 mb-8">
      ...
      <div className="w-full flex flex-col items-center bg-white shadow-sm">
        <div className="w-full max-w-7xl flex items-center gap-3 py-6 px-4">
          ...
          <span className="text-2xl font-semibold text-gray-800">{ecommerceName} Ayarları</span>
        </div>
        {/* Sekme Barı */}
      ...
      <div className="w-full max-w-7xl flex gap-8 px-4">
        ...
        <div className="w-full bg-[#F8FAFC] p-8 flex flex-col gap-4 min-w-[350px]">
          ...
          <div className="overflow-y-auto max-h-[340px] pr-2 text-gray-700 text-sm leading-relaxed">
            ...
            E-ticaret entegrasyonunu gerçekleştirebilmek için ilk olarak API Bilgisi almanız gerekmektedir. Bu bilgiye yönetim panelinizden ulaşabilirsiniz.<br/><br/>
            *API bilgisini nasıl alacağınızı öğrenmek için ilgili destek yazımızı inceleyebilirsiniz.<br/><br/>
            API bilgisini aldıktan sonra E-ticaret API Ayarları sayfasının API Bilgileri Tanımlama kısmında bulunan API Name alanına API Kullanıcı Adını, API KEY kısmına da Şifre bilgilerini yazmalısınız.<br/><br/>
