    ...
    <div className="min-h-screen bg-[#F5F7FA] flex flex-col items-center py-0 mb-8  bg-[#f2f8ff]">
      ...
      <div className="w-full flex flex-col items-start bg-white px-2 md:px-4 lg:px-6">
        <div className="w-full flex items-center gap-3 py-6 px-0">
          ...
          <span className="text-2xl font-semibold text-gray-800">Ticimax Ayarları</span>
        </div>
        {/* Sekme Barı */}
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-8 px-2 md:px-4 lg:px-6 mt-8">
        ...
        <div className="bg-white p-8 flex flex-col gap-6 rounded-xl shadow-sm min-w-[320px] h-full max-h-[600px] self-stretch">
          ...
          <form className="flex flex-col gap-4">
            ...
            <div>
              <label className="block text-[#5d6e76] font-black mb-1">
              API ANAHTARI <span className="text-red-500">*</span>
              </label>
              <input type="text" className="input" placeholder="" />
            </div>
            <div>
        ...
        <div className="bg-white p-8 flex flex-col gap-4 rounded-xl border border-[#e5e7eb] shadow-sm min-w-[320px] h-full self-stretch max-h-[600px]">
          ...
          <div className="bg-white text-gray-800 text-base leading-relaxed border-b border-gray-200 pb-4 max-h-[300px] overflow-y-auto pr-2">
            ...
            Ticimax entegrasyonunu gerçekleştirebilmek için ilk olarak API Bilgisi almanız gerekmektedir. Bu bilgiye Ticimax yönetim panelinizden ulaşabilirsiniz.<br /><br />
            *API bilgisini nasıl alacağınızı öğrenmek için ilgili destek yazımızı inceleyebilirsiniz.<br /><br />
            API bilgisini aldıktan sonra Ticimax API Ayarları sayfasının API Bilgilerini Tanımlama kısmında bulunan Site Linki alanına sitenizin adresini, API Anahtarı kısmına da Yekti Kodu bilgilerini yazmalısınız.
            </div>
          </div>
