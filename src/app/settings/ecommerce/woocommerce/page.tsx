    ...
    <div className="min-h-screen bg-[#F5F7FA] flex flex-col items-center py-0 mb-8  bg-[#f2f8ff]">
      ...
      <div className="w-full flex flex-col items-start bg-white px-2 md:px-4 lg:px-6">
        <div className="w-full flex items-center gap-3 py-6 px-0">
          {/* Woocommerce icon yok, sadece başlık */}
          <Image src="/production.svg" alt="opencart" width={32} height={26} />
          <span className="text-2xl font-semibold text-gray-800">Woocommerce Ayarları</span>
        </div>
        {/* Sekme Barı */}
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-8 px-2 md:px-4 lg:px-6 mt-8">
        ...
        <div className="bg-white p-8 flex flex-col gap-6 rounded-xl shadow-sm min-w-[320px] h-full max-h-[600px] self-stretch">
          ...
          <form className="flex flex-col gap-4">
            ...
            <div>
              <label className="block text-[#5d6e76] font-black mb-1">
                TÜKETİCİ ANAHTARI <span className="text-red-500">*</span>
              </label>
              <input type="text" className="input" placeholder="" />
            </div>
            <div>
              <label className="block text-[#5d6e76] font-black mb-1">
                TÜKETİCİ GİZLİ ANAHTARI <span className="text-red-500">*</span>
              </label>
              <input type="text" className="input" placeholder="" />
            </div>
            <div>
        ...
        {/* Sağ: Kurulum Rehberi */}
        <div className="bg-white p-8 flex flex-col gap-4 rounded-xl border border-[#e5e7eb] shadow-sm min-w-[320px] h-full self-stretch max-h-[600px]">
          ...
          <div className="font-semibold">1- API Bilgilerinizi Tanımlayın</div>
              ...
              Woocommerce entegrasyonunu gerçekleştirebilmek için ilk olarak API Bilgisi almanız gerekmektedir. Bu bilgiye Woocommerce yönetim panelinizden ulaşabilirsiniz.<br /><br />

*API bilgisini nasıl alacağınızı öğrenmek için ilgili destek yazımızı inceleyebilirsiniz.<br /><br />

API bilgisini aldıktan sonra Woocommerce API Ayarları sayfasının API Bilgilerini Tanımlama kısmında bulunan Site Linki alanına sitenizin adresini, Tüketici Anahtarı kısmına Tüketici Anahtarını ve Tüketici Gizli Anahtarı kısmına da Tüketici Gizli Anahtarı bilgilerini yazmalısınız.<br /><br />
              </div>
              <div className="font-semibold mt-2">2- Ürünlerinizi Aktarın</div><br />
              <div className="mt-1 font-light">
              Ürünlerinizde bir fiyat kuralı uygulayacaksanız Entekas&apos;a aktarmadan önce ilk olarak sayfanın alt kısmında bulunan ilgili alandan bu fiyat kurallarını belirlemeniz gerekmektedir.<br /><br />

Süreç Seçimleri alanında da ürün çekimi ve fatura ile ilgili gerekli ayarlamaları belirlemeniz gerekmektedir.<br /><br />

Fiyat kuralı belirleme ve süreç seçimleri işlemlerinden sonra sayfanın sol üst kısmında bulunan Ürünleri Aktar butonuna tıklayarak aktarma işlemini başlatabilirsiniz.<br /><br />
              </div>
              <div className="font-semibold mt-2">3- Aktarım Detaylarını İnceleyin</div><br />
              <div className="mt-1 font-light">
              Aktarım işlemi tamamlandıktan sonra sayfanın sağ üst kısmında bulunan Aktarım Detayları alanında aktarım işlemi ile ilgili detaylı bilgiye ulaşabilirsiniz.<br /><br />

Mavi alanda aktarılan toplam ürün adedi bilgisi yer alır.<br /><br />

              Yeşil alanda aktarılan ürünler ile eşleşen ürünlerin(Entekas&apos;da olan ürünlerle) toplam adet bilgisi yer alır.<br /><br />
