    ...
    <div className="min-h-screen bg-[#F5F7FA] flex flex-col items-center py-0 mb-8  bg-[#f2f8ff]">
      ...
      <div className="w-full flex flex-col items-start bg-white px-2 md:px-4 lg:px-6">
        <div className="w-full flex items-center gap-3 py-6 px-0">
          ...
          <span className="text-2xl font-semibold text-gray-800">Shopier Ayarları</span>
        </div>
        {/* Sekme Barı */}
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-8 px-2 md:px-4 lg:px-6 mt-8">
        ...
        <div className="bg-white p-8 flex flex-col gap-6 rounded-xl shadow-sm min-w-[320px] h-full max-h-[450px] self-stretch">
          <div className="flex items-center gap-3 mb-4 border-b-2 border-gray-200 pb-4">
            <div className="text-xl font-semibold text-[#37474f]">Shopier Entegrasyon Ayarları</div>
          </div>
          <form className="flex flex-col gap-4">
          <div>
              <label className="block text-[#5d6e76] font-black mb-1">
              SHOPIPER UYGULAMASI <span className="text-red-500">*</span>
              </label>
              <a
                href="#"
        ...
        <div className="bg-white p-8 flex flex-col gap-4 rounded-xl border border-[#e5e7eb] shadow-sm min-w-[320px] h-full self-stretch max-h-[450px]">
          ...
          <div className="font-semibold">1- Shopier Bağlantısı Kurun</div>
              <div className="mt-2 font-light">
              Shopier entegrasyonunu gerçekleştirebilmek için ilk olarak sol tarafta yer alan &quot;Shopier&apos;a bağlanmak için tıklayın&quot; butonuna tıklayın. Açılan sayfa sizi Shopier&apos;a yönlendirecek. Mağaza bilgileriniz ile giriş sağlayın. Giriş sağladıktan sonra Shopier sizden Entekas ile entegrasyon için onay vermenizi isteyecek, açılan modalı onaylayın.
