    ...
    <div className="min-h-screen bg-[#f5f8ff] p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-2 mb-6">
          <span className="text-blue-600 font-medium text-sm border-b-2 border-blue-600 pb-1">QNB eFinans E-Fatura Ayarları</span>
        </div>
          ...
          <div className="md:col-span-2 bg-white rounded-xl shadow p-6">
            ...
            <form className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium mb-1">KDV İSTİSNA KODU</label>
                  <select className="w-full border rounded px-3 py-2 text-sm bg-white">
                    <option>KDV İstisnası Seçiniz</option>
                  </select>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" className="w-full border rounded px-3 py-2 text-sm" placeholder="Üç harf, örneğin Sopay şirketi için SOP gibi" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1">E-ARŞİV NUMARA EKİ</label>
                  <input type="text" className="w-full border rounded px-3 py-2 text-sm" placeholder="Üç harf, örneğin Sopay şirketi için SPY gibi" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1">TELEFON</label>
                  <input type="text" className="w-full border rounded px-3 py-2 text-sm" placeholder="Faturada yazacak olan telefon numarası" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1">E-POSTA</label>
                  <input type="email" className="w-full border rounded px-3 py-2 text-sm" placeholder="Faturada yazacak olan E-posta adresidir" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1">WEB SİTESİ</label>
          ...
          <div className="bg-white rounded-xl shadow p-6 flex flex-col justify-between">
            <div>
              ...
              <div className="text-sm text-gray-600 max-h-40 overflow-y-auto mb-4">
                QNB eFinans Entegrasyonunu gerçekleştirebilmek için E-Fatura kullanıcı kodu ve şifrenizi bilmeniz gerekmektedir. E-Fatura kullanıcı kodu ve şifrenizi bilmiyorsanız mali müşavirinizden öğrenebilirsiniz. E-Fatura Kullanıcı Bilgileri ve/veya E-Arşiv Kullanıcı Bilgileri alanlarına kullanıcı kodu ve şifre bilgilerinizi yazıyorsunuz. Vergi Bilgileri kısmında gereken bilgileri (şirket türü, vergi numarası, vergi dairesi, mersis numarası ve sicil numarası) ilgili alanlara yazıyorsunuz. Fatura Sabit Bilgileri kısmında da gereken bilgileri ilgili alanlara yazıyorsunuz.
              </div>
            </div>
