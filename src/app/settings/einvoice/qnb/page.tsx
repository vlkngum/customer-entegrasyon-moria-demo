    ...
    <div className="min-h-screen bg-[#f8fafc]">
      ...
      <div className="bg-white w-full shadow-sm pl-6 pr-16 pt-8 ml-0">
        <div className="flex items-center gap-3 mb-2">
          <Image src="/production.svg" alt="QNB eFinans Logo" width={32} height={26} />
          <h1 className="text-2xl font-semibold text-[#222]">QNB eFinans E-Fatura Ayarları</h1>
        </div>
        <div>
          <span className="text-[#1e90ff] text-base font-semibold border-b-2 border-[#1e90ff] pb-1 inline-block mt-2">QNB eFinans E-Fatura Ayarları</span>
        </div>
      </div>
      {/* İçerik */}
          ...
          <div className="bg-white rounded-xl shadow p-4 md:p-4 flex flex-col gap-6 w-full flex-1 mb-12">
            ...
            <div className="flex items-center gap-4 border-b border-gray-200">
              <div className="w-20 h-20 rounded-full flex items-center justify-center overflow-hidden">
                <Image src="/indir (1).png" width={80} height={80} alt="QNB eFinans Logo" className="object-contain w-full h-2/3" />
              </div>
              <span className="text-xl font-semibold text-[#222]">QNB eFinans E-Fatura Ayarları</span>
            </div>
            {/* Form */}
